...
export const TAG_DESCRIPTIONS: Record<string, string> = {
  ...
  AccordionItem: 'Accordion の1つのセクション。見出しと開閉コンテンツを持つ',
  AccordionHeader: 'AccordionItem の見出し部分。クリックで開閉する',
  AccordionBody: 'AccordionItem の開閉コンテンツ部分',
  TabItem: 'Tabs の1つのタブ。ラベルとパネルを持つ',
  TabLabel: 'TabItem のラベル部分。タブの見出しテキスト',
  TabPanel: 'TabItem のパネル部分。タブの内容を配置する',
...
export const TAG_CATEGORIES: Record<string, TagName[]> = {
  ...
  'COMPOSITE': ['Card', 'Modal', 'Table', 'Accordion', 'Carousel', 'Kanban', 'Timeline', 'List', 'Tree', 'PricingTable', 'FAQSection', 'NotificationPanel',
    ...
    'AccordionItem', 'AccordionHeader', 'AccordionBody', 'TabItem', 'TabLabel', 'TabPanel', 'TreeNode'],
